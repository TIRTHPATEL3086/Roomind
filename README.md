...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=4F46E5&height=60&text=🛠️%20TECHNOLOGY%20ECOSYSTEM&fontColor=ffffff&fontSize=30&stroke=000000" alt="Tech Stack Banner"/>
</div>
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=3B82F6&height=60&text=🧠%20AI%20&%20SPATIAL%20ALGORITHMS&fontColor=ffffff&fontSize=30&stroke=000000" alt="AI Banner"/>
</div>
...
```mermaid
graph TD
    A[📱 Mobile RGBD Scan] --> B[👁️ Open3D Pipeline: Depth Fusion]
    B --> C[🧊 Mesh Generation & Navmesh]
    C --> D[🗺️ Semantic Scene Graph]
    
    E[🗣️ User Ask: 'Where is the chair?'] --> F[🧠 LLM Intent & Spatial Grounding]
    F --> G{Resolve Object in Scene Graph}
    G --> H[🤖 Kinematics Engine]
    H --> I[📍 ARIA Navigates & Points]
    
    J[📸 User Uploads Image] --> K[✨ GenAI Image-to-3D]
    K --> D
```
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=2563EB&height=60&text=🏗️%20SYSTEM%20ARCHITECTURE&fontColor=ffffff&fontSize=30&stroke=000000" alt="Architecture Banner"/>
</div>
...
flowchart TB
    subgraph Presentation [Presentation Layer]
        WEB[Web Dashboard / GSAP Landing]
        API[FastAPI REST + WebSocket API]
    end

    subgraph Orchestration [Orchestration Layer]
        RECON[Twin Generator]
        IMAGINE[Imagine Manager]
        ROBOT[Robot Manager]
    end
    ...
    subgraph Execution [Execution Layer]
        R3F[React Three Fiber Twin]
        HW[Arduino UNO Q]
    end

    WEB <--> API
    API --> Orchestration
    Orchestration --> AIServices
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=rect&color=1D4ED8&height=60&text=🚀%20QUICKSTART%20GUIDE&fontColor=ffffff&fontSize=30&stroke=000000" alt="Quickstart Banner"/>
</div>
